<x-layouts.user title="Pengaturan" pageTitle="Pengaturan" :user="auth()->user()->penduduk->nama_lengkap ?? auth()->user()->name">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        <a href="{{ route('user.pengaturan.profil') }}"
            ...
            <h2 class="mt-4 text-lg font-bold text-slate-800">Profil Saya</h2>
            <p class="mt-1 text-sm text-slate-500">
                Lihat dan perbarui data diri Anda.
            </p>
        </a>

        <a href="{{ route('user.pengaturan.akun') }}"
            class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
            ...
            <p class="mt-1 text-sm text-slate-500">
                Atur username, email, dan informasi akun.
            </p>
        </a>

        <a href="{{ route('user.pengaturan.password') }}"
            class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
