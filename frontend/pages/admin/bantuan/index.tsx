    ...
    <AdminLayout pageTitle="Data Bantuan" subtitle="Kelola dan pantau penyaluran bantuan sosial bagi warga">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm space-y-4">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
          {/* Search Box dengan Ikon Kaca Pembesar */}
          <div className="relative">
            ...
            <input
              ...
              placeholder="Cari nama, NIK, program..."
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-slate-100">
          ...
          {/* Seluruh Tombol Aksi Digabung Rapi di Sisi Kanan */}
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            {/* Tombol Utama: Ajukan Bantuan (Warna Tema Hijau Emerald Seragam) */}
            <Link
