  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showAlert({
        ...
        message: 'Program bantuan telah berhasil dihapus.',
      })
    } catch (err) {
      ...
      showAlert({
        ...
        message: 'Terjadi kesalahan saat menghapus program bantuan.',
      })
    } finally {
      setDeleting(false)
    }
